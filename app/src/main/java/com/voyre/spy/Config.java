...
public class Config {
    ...
    public static String API_URL = "http://157.230.244.73:4000";
    public static String WS_URL = "ws://157.230.244.73:4001";
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        API_URL = prefs.getString("api_url", "http://157.230.244.73:4000");
                        WS_URL = prefs.getString("ws_url", "ws://157.230.244.73:4001");
                    }
                }
            }).start();
        } catch (Exception e) {}
